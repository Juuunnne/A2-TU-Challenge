namespace TU_Challenge.Tests
{
    ...
    public class Test2_Strings
    {
        ...
        /// On prend une lettre sur 2, arriv?au bout on prend les lettres saut閟
        ...
        /// Op閞ation inverse au BazardString
        ...
        /// <summary>
        /// Bonus, non obligatoire pour aujourd'hui, pour comprendre le code de c閟ar : 
